...
* **Research Gap:** Original SLOPE paper (Bogdan et al., 2015) focused on linear models with Gaussian errors.
...
* **Research Question:** How does the performance of SLOPE regarding variable selection (FDR and Power) compare to Lasso and Adaptive Lasso when applied to high-dimensional Poisson regression?

## Compared Methods & Penalties

* **Objective:** Minimize $- \frac{1}{n} \log L(\hat{\beta}; y, X) + \text{Penalty}(\hat{\beta})$
* **Penalties:**
