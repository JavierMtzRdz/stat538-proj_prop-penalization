...
* **Research Gap:** Original SLOPE paper (Bogdan et al., 2015) only discusses linear models with Gaussian error terms[cite: 1].
...
* **Penalties:**
    ...
    * **Adaptive Lasso:** $\lambda \sum_{j=1}^{p} w_j |\beta_j|$ (where $w_j \propto |\hat{\beta}_{init, j}|^{-\gamma}$)
